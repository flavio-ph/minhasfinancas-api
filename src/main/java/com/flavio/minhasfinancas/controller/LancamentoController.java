...
import com.flavio.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.flavio.minhasfinancas.api.dto.LancamentoDTO;
...
public class LancamentoController {
	...
	public ResponseEntity salvar(@RequestBody LancamentoDTO dto) {
		try {
				Lancamento entidade = coverter(dto);
		...
		try {
					Lancamento lancamento = coverter(dto);
	...
	private Lancamento coverter(LancamentoDTO dto) {
		...
		if(dto.getTipo() != null) {
			lancamento.setTipo(TipoDeLancamento.valueOf(dto.getTipo()));
		}
		
		if(dto.getStatus() != null) {
			lancamento.setStatus(Status.valueOf(dto.getStatus()));
		}
